...
#define APPVERSION STR(APPVERSION_MAJOR) "." STR(APPVERSION_MINOR) "." STR(APPVERSION_PATCH)
...
// API-constants
#define API_GENERATE_ADDRESSES_MAX_COUNT	(API_BUFFER_SIZE_BYTES/ADDRESS_WITH_TYPE_SIZE_BYTES)
