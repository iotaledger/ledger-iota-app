...
void ux_layout_pb_ud_init(unsigned int stack_slot) {
  ...
  G_ux.stack[stack_slot].element_arrays[0].element_array = ux_layout_pb_ud_elements;
  G_ux.stack[stack_slot].element_arrays[0].element_array_count = ARRAYLEN(ux_layout_pb_ud_elements);
  G_ux.stack[stack_slot].element_arrays_count = 1;
  G_ux.stack[stack_slot].screen_before_element_display_callback = ux_layout_pb_ud_prepro;
